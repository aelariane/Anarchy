...
**What will you need?**
  ...
  *  **Download [Modding-(Version).zip](https://github.com/Orrder/Anarchy/releases/download/BETA-9.5.0/Modding-9.5.0.zip) archieve (This link always refers to latest release)**
<br/>
