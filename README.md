...
**What will you need?**
  ...
  *  **Download [Modding-(Version).zip](https://github.com/Orrder/Anarchy/releases/download/BETA-9.6.1/Modding-9.6.2.zip) archieve (This link always refers to latest release)**
<br/>
