...
namespace Anarchy.Network.Discord
{
    internal class DiscordRPC
    {
        ...
        public class RichPresence
        {
            ...
            public string partyId = null; /* max 128 bytes */
            public int partySize;
            public int partyMax;
            public string matchSecret = null; /* max 128 bytes */
            public string joinSecret = null; /* max 128 bytes */
            public string spectateSecret = null; /* max 128 bytes */
